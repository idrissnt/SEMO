...
class _FakeVerifyEmailCodeState_0 extends _i1.SmartFake
    implements _i2.VerifyEmailCodeState {
  _FakeVerifyEmailCodeState_0(
    Object parent,
...
/// A class which mocks [VerifyEmailCodeBloc].
///
/// See the documentation for Mockito's code generation for more information.
class MockVerifyEmailCodeBloc extends _i1.Mock
    implements _i4.VerifyEmailCodeBloc {
  MockVerifyEmailCodeBloc() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i2.VerifyEmailCodeState get state => (super.noSuchMethod(
        Invocation.getter(#state),
        returnValue: _FakeVerifyEmailCodeState_0(
          this,
          Invocation.getter(#state),
        ),
      ) as _i2.VerifyEmailCodeState);

  @override
  _i5.Stream<_i2.VerifyEmailCodeState> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i5.Stream<_i2.VerifyEmailCodeState>.empty(),
      ) as _i5.Stream<_i2.VerifyEmailCodeState>);
  ...
  @override
  void add(_i6.VerifyEmailCodeEvent? event) => super.noSuchMethod(
        Invocation.method(
          #add,
          [event],
        ),
  ...
  @override
  void onEvent(_i6.VerifyEmailCodeEvent? event) => super.noSuchMethod(
        Invocation.method(
          #onEvent,
          [event],
        ),
  ...
  @override
  void emit(_i2.VerifyEmailCodeState? state) => super.noSuchMethod(
        Invocation.method(
          #emit,
          [state],
        ),
  ...
  @override
  void on<E extends _i6.VerifyEmailCodeEvent>(
    _i7.EventHandler<E, _i2.VerifyEmailCodeState>? handler, {
  ...
  @override
  void onTransition(
          _i7.Transition<_i6.VerifyEmailCodeEvent, _i2.VerifyEmailCodeState>?
              transition) =>
      super.noSuchMethod(
        Invocation.method(
          #onTransition,
  ...
  @override
  void onChange(_i7.Change<_i2.VerifyEmailCodeState>? change) =>
      super.noSuchMethod(
        Invocation.method(
          #onChange,
          [change],
...
class MockAuthBloc extends _i1.Mock implements _i8.AuthBloc {
  ...
  @override
  void onTransition(
          _i7.Transition<_i10.AuthEvent, _i3.AuthState>? transition) =>
      super.noSuchMethod(
        Invocation.method(
          #onTransition,
          [transition],
