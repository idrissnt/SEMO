...
class HomeUserAddressUseCases {
  ...
  Future<Result<UserAddress, DomainException>> createAddress(UserAddress address) {
    return _userAddressRepository.createAddress(address);
  }

  /// Update an existing address
  Future<Result<UserAddress, DomainException>> updateAddress(UserAddress address) {
