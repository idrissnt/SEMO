...
class LoginScreenPrevious extends StatefulWidget {
  const LoginScreenPrevious({Key? key}) : super(key: key);

  @override
  State<LoginScreenPrevious> createState() => _LoginScreenPreviousState();
}

class _LoginScreenPreviousState extends State<LoginScreenPrevious>
