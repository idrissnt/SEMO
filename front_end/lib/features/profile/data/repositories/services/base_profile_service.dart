    ...
    return _authenticatedRequest<User>(
      requestFn: (token, userId) async {
        ...
        final response = await _dio.get(
          '${AppConfig.apiBaseUrl}${AppConfig.profileEndpoint}$userId/',
    ...
    return _authenticatedRequest<User>(
      requestFn: (token, userId) async {
        ...
        final response = await _dio.patch(
          '${AppConfig.apiBaseUrl}${AppConfig.profileEndpoint}$userId/update-profile/',
          data: updateData,
          options: Options(headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $token',
    ...
    return _authenticatedRequest<bool>(
      requestFn: (token, userId) async {
        ...
        final response = await _dio.delete(
          '${AppConfig.apiBaseUrl}${AppConfig.profileEndpoint}$userId/delete-account/',
          options: Options(headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $token',
          }),
