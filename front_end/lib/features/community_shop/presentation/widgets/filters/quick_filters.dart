...
import 'package:semo/features/community_shop/presentation/widgets/filters/components/filter_chips.dart';
import 'package:semo/features/community_shop/presentation/widgets/filters/components/filter_constants.dart';
import 'package:semo/features/community_shop/presentation/widgets/filters/components/filter_dialogs.dart';
          ...
          children: [
            ...
            SimpleFilterChip(
              ...
              onSelected: (selected) {
                ...
                if (selected &&
                    _filterValues.containsKey(FilterConstants.kOneMarket)) {
            ...
            SimpleFilterChip(
              ...
              onSelected: (selected) =>
                  _updateFilter(FilterConstants.kUrgent, selected),
            ),
            const SizedBox(width: 8),
            ...
            SimpleFilterChip(
              ...
              onSelected: (selected) =>
                  _updateFilter(FilterConstants.kHighReward, selected),
            ),
          ],
        ),
      ),
