...
/// Class that manages the animations for the category screen
class CategoryAnimationManager {
  ...
  /// Creates a new category animation manager
  CategoryAnimationManager({
    ...
    filterAnimation =
        CurvedAnimation(parent: filterController, curve: Curves.easeOutQuad);
    ...
    productsAnimation =
        CurvedAnimation(parent: productsController, curve: Curves.easeOutQuad);
