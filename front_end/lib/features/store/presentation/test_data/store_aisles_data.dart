          ...
          AisleCategory(
            ...
            products: [
              CategoryProduct(
                ...
                productUnit: 'lb',
                unit: 'lb',
                ingredient: 'Fresh ground beef, 85% lean',
              ),
              CategoryProduct(
                id: 'prod-023',
                name: 'Ribeye Steak',
          ...
          AisleCategory(
            ...
            products: [
              ...
              CategoryProduct(
                ...
                productUnit: 'each',
                unit: 'each',
                ingredient: 'Fresh whole chicken',
              ),
            ],
          ),
          // Seafood Subcategory
          AisleCategory(
            ...
            products: [
              CategoryProduct(
                ...
                productUnit: 'lb',
                unit: 'lb',
                ingredient: 'Fresh Atlantic salmon fillet',
              ),
              CategoryProduct(
                id: 'prod-027',
                name: 'Shrimp',
                ...
                productUnit: 'lb',
                unit: 'lb',
                ingredient: 'Large peeled and deveined shrimp',
              ),
            ],
          ),
        ],
          ...
          AisleCategory(
            ...
            products: [
              CategoryProduct(
                ...
                productUnit: 'box',
                unit: 'box',
                ingredient: 'Dried spaghetti pasta',
              ),
              CategoryProduct(
                id: 'prod-029',
                name: 'Jasmine Rice',
                ...
                unit: '2 lb bag',
                ingredient: 'Premium jasmine rice',
              ),
            ],
          ),
          ...
          AisleCategory(
            ...
            products: [
              CategoryProduct(
                ...
                productUnit: 'can',
                unit: 'can',
                ingredient: 'Diced canned tomatoes',
              ),
              CategoryProduct(
                id: 'prod-031',
                ...
                productUnit: 'can',
                unit: 'can',
                ingredient: 'Classic chicken noodle soup',
              ),
            ],
          ),
        ],
          ...
          AisleCategory(
            ...
            products: [
              CategoryProduct(
                ...
                unit: '12 oz bag',
                ingredient: 'Medium roast ground coffee',
              ),
              CategoryProduct(
                id: 'prod-033',
                name: 'Green Tea',
                ...
                productUnit: 'box',
                unit: 'box',
                ingredient: 'Organic green tea, 20 tea bags',
              ),
            ],
          ),
          ...
          AisleCategory(
            ...
            products: [
              ...
              CategoryProduct(
                ...
                productUnit: 'can',
                unit: 'can',
                ingredient: 'Lime flavored sparkling water',
              ),
            ],
          ),
        ],
