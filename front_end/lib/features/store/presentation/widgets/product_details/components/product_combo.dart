...
import 'package:semo/features/store/presentation/widgets/product_details/components/add_to_cart_button.dart';
...
class ProductCombo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (relatedProducts.length < 3) {
      return const SizedBox.shrink(); // Don't show this section if not enough products
    }
